...
exports.ControlModule = ControlModule = __decorate([
    (0, common_1.Module)({
        providers: [rate_limit_service_1.RateLimitService, circuit_breaker_service_1.CircuitBreakerService],
        exports: [rate_limit_service_1.RateLimitService, circuit_breaker_service_1.CircuitBreakerService],
    })
], ControlModule);
